...
exports.config = {
	...
	cucumberOpts: {
		require: ['./stepsDefinition/*/*'],   // <string[]> (file/dir) require files before executing features
		...
		tagExpression: '@test', // <string> (expression) only execute the features or scenarios with tags matching the expression
